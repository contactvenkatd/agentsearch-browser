...
[[maybe_unused]] scoped_refptr<RefcountedKeyedService> BuildPasswordStore(
  ...
  scoped_refptr<PasswordStore> ps =
      base::MakeRefCounted<password_manager::PasswordStore>(
          CreatePasswordStoreBackend(password_manager::kProfileStore,
...
ProfilePasswordStoreFactory::GetForProfile(Profile* profile,
  ...
  return base::WrapRefCounted(
      static_cast<PasswordStoreInterface*>(service.get()));
}
